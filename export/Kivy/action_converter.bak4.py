...
class ActionConverter:
    ...
    def _convert_set_hspeed(self, params: Dict[str, Any], indent_level: int) -> str:
        ...
        # Multiply by 4 for responsive grid-based movement in Kivy
        # At speed 4, this becomes 16 pixels/frame = 2 frames per 32px grid cell
        speed = speed * 4
    ...
    def _convert_set_vspeed(self, params: Dict[str, Any], indent_level: int) -> str:
        ...
        speed = params.get('speed', 0)
        # Multiply by 4 for responsive grid-based movement, and INVERT for Kivy's Y-axis
        # At speed 4, this becomes 16 pixels/frame = 2 frames per 32px grid cell
        speed = -speed * 4
