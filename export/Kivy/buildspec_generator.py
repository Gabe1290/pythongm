...
"""
    ...
    def _generate_package_name(self, project_name: str) -> str:
        ...
        # underscores. Restrict to ASCII a-z0-9: str.isalnum() is True for
        # accented letters ('é'.isalnum() is True), which produce an invalid
        # Android applicationId and fail the build late (L20). Transliterate
        # accents first so "L'épopée" -> "l_epopee" rather than dropping them.
        normalized = unicodedata.normalize('NFKD', project_name.lower())
