...
- `docs/RELEASE_QA_CHECKLIST.md` — the **master** checklist: sequences
  this eyes-only pass, the feature-regression list and every "needs a
  device / two machines" item into one release sign-off
