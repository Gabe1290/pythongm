...
> TIP: **Projets de référence.** Téléchargez les projets par étapes sur le wiki (`06_maze_checkpoints.zip`) : un projet pour la fin de chaque phase, avec le labyrinthe d'exemple du tutoriel plus cinq pièces et une sortie. Donnez à un élève bloqué la phase précédente.
