...
> TIP: **Projets de référence.** Téléchargez les projets par étapes sur le wiki (`03_pong_checkpoints.zip`) : un projet pour la fin de chaque phase. Donnez à un élève bloqué la phase précédente pour qu'il continue.
