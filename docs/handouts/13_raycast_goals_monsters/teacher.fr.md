...
> TIP: **Projets de référence.** Téléchargez les projets par étapes sur le wiki (`13_raycast_goals_monsters_checkpoints.zip`) : le projet au début de la leçon (issu du Tutoriel 11) et le jeu terminé avec une gemme, un monstre et la sortie. Donnez à un élève bloqué le projet terminé pour qu'il se compare.
