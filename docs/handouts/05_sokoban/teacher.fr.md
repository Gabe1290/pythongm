...
> TIP: **Projets de référence.** Téléchargez les projets par étapes sur le wiki (`05_sokoban_checkpoints.zip`) : un projet pour la fin de chaque phase, avec le niveau d'exemple du tutoriel. Donnez à un élève bloqué la phase précédente.
