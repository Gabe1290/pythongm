...
> DONE: **Tu dois voir :** appuie sur **F5**. Chaque appui sur une touche te déplace d'exactement une case. Les murs t'arrêtent.
...
> DONE: **Tu dois voir :** appuie sur **F5**. Avance vers une caisse et elle bouge d'une case. Elle ne bouge pas s'il y a un mur ou une autre caisse derrière.
...
> DONE: **Tu dois voir :** appuie sur **F5**. Pousse une caisse sur une cible et elle devient verte ; pousse-la ailleurs et elle redevient brune. **R** remet tout en place.

> TIP: **Pourquoi placer les cibles d'abord ?** Le jeu dessine les éléments dans l'ordre où tu les as placés. Une cible placée après une caisse ou le joueur est dessinée par-dessus, et une caisse sur une cible resterait cachée sous la marque rouge.
