...
> TIP: **Projets de référence.** Téléchargez les projets par étapes sur le wiki (`07_platformer_checkpoints.zip`) : un projet pour la fin de chaque phase, avec un petit niveau. Donnez à un élève bloqué la phase précédente.
