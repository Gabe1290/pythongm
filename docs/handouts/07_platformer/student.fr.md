...
> DONE: **Tu dois voir :** appuie sur **F5**. Le joueur tombe sur le sol, court à gauche et à droite, et la flèche haut le fait sauter d'environ trois cases de haut. Il atterrit sur les plateformes.
...
> DONE: **Tu dois voir :** appuie sur **F5**. Les pièces disparaissent et valent 10. Un pic recommence le niveau. Le drapeau affiche « You Win! ».
...
> DONE: **Tu dois voir :** appuie sur **F5**. Le score et les vies sont affichés. Chaque pic coûte une vie et recommence la salle, et les vies restent plus basses.

> TIP: **Game Start, pas Création.** Un événement Création se relance à chaque redémarrage de la salle. Si les vies étaient réglées à 3 dans Création, chaque pic te les rendrait et tu n'en manquerais jamais.
