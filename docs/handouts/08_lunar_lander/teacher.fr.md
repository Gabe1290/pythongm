...
> TIP: **Projets de référence.** Téléchargez les projets par étapes sur le wiki (`08_lunar_lander_checkpoints.zip`) : un projet pour la fin de chaque phase, avec un niveau où l'aire est dans un trou. Donnez à un élève bloqué la phase précédente.
