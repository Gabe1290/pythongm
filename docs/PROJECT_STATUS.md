...
3. **`docs/WIKI_TUTORIAL_SCREENSHOTS_PLAN.md` — Phase 1 done (2026-09-11),
   ...
   Breakout, Pong, Sokoban and now **Maze** each have per-step screenshots
   (`wiki/images/tutorial-{breakout,pong,sokoban,maze}-*.png`) embedded at their
   ...
   ask" framing**: Platformer/LunarLander (Phase 2) and all
