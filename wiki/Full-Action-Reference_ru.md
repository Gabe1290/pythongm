...
На этой странице перечислены все **161** действия, доступные в PyGameMaker, именно так, как они отображаются в средстве выбора действий IDE (включая плагин Audio и расширение 3D-вид). Действия — это команды, которые выполняются при срабатывании события.
