...
**Télécharger :** [PDF](downloads/Teacher-Guide-11-raycast-first-steps_fr.pdf) · [ODT](downloads/Teacher-Guide-11-raycast-first-steps_fr.odt) · [Projets de référence (ZIP)](downloads/solutions/11_raycast_first_steps_checkpoints.zip)
...
> **Astuce:** **Projets de référence.** Téléchargez le projet terminé de la leçon sur le wiki (`11_raycast_first_steps_checkpoints.zip`). Donnez à un élève bloqué le projet terminé pour qu'il se compare.
