...
Veja a [Referência completa de ações](Full-Action-Reference_pt#3d-view) para todos os
parâmetros.
...
- [Referência completa de ações](Full-Action-Reference_pt#3d-view) — as quatro ações em detalhe
