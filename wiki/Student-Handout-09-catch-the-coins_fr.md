...
**Télécharger :** [PDF](downloads/Student-Handout-09-catch-the-coins_fr.pdf) · [ODT](downloads/Student-Handout-09-catch-the-coins_fr.odt)
...
> **Réussi:** **Tu dois voir :** appuie sur **F5**. Gauche et Droite déplacent le joueur, et il s'arrête quand tu relâches. Il peut sortir de l'écran pour l'instant.
...
> **Réussi:** **Tu dois voir :** appuie sur **F5**. Les pièces et l'ennemi tombent. Les toucher ne fait rien pour l'instant. Tout ce que tu rates revient en haut.
...
> **Réussi:** **Tu dois voir :** appuie sur **F5**. Attraper une pièce ajoute 1 et la pièce disparaît. Toucher l'ennemi affiche l'écran Game Over, et ESPACE recommence.
...
> **Réussi:** **Tu dois voir :** appuie sur **F5**. Attrape toutes les pièces et la salle YOU WIN! apparaît. Touche l'ennemi et tu obtiens Game Over. ESPACE lance une nouvelle partie depuis chacune.
