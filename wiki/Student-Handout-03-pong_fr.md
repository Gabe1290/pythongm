...
**Télécharger :** [PDF](downloads/Student-Handout-03-pong_fr.pdf) · [ODT](downloads/Student-Handout-03-pong_fr.odt)
...
> **Réussi:** **Tu dois voir :** appuie sur **F5**. Les deux raquettes bougent avec leurs touches et s'arrêtent aux murs. La balle part en haut à droite, rebondit sur les murs et les raquettes, et si tu la rates elle sort sur le côté de l'écran. C'est normal pour l'instant.
...
> **Réussi:** **Tu dois voir :** appuie sur **F5**. Quand la balle dépasse une raquette, elle retourne au centre. Tu ne vois pas encore le score.
...
> **Réussi:** **Tu dois voir :** appuie sur **F5** et joue un point avec ton ou ta partenaire. Les scores s'affichent en haut à gauche et augmentent quand l'autre joueur rate la balle.
