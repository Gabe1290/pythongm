...
**Télécharger :** [PDF](downloads/Student-Handout-08-lunar-lander_fr.pdf) · [ODT](downloads/Student-Handout-08-lunar-lander_fr.odt)
...
> **Réussi:** **Tu dois voir :** appuie sur **F5**. L'atterrisseur tombe lentement. Maintiens **Haut** pour monter, **Gauche** et **Droite** pour diriger. Relâche tout et il dérive vers le bas. (Il traverse le sol pour l'instant : pas encore d'événement de collision.)
...
> **Réussi:** **Tu dois voir :** appuie sur **F5**. Touche l'aire et tu obtiens « Landing successful! » une seule fois. Touche le sol et tu obtiens « Crashed! » et le niveau recommence. Utilise de courts appuis sur **Haut** pour contrôler ta chute.
...
> **Réussi:** **Tu dois voir :** appuie sur **F5**. Le titre et les instructions s'affichent en haut à gauche, en blanc.
