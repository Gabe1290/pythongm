...
**Télécharger :** [PDF](downloads/Student-Handout-12-raycast-textures_fr.pdf) · [ODT](downloads/Student-Handout-12-raycast-textures_fr.odt)
...
> **Réussi:** **Tu dois voir :** appuie sur **F5**. Chaque mur montre des briques. Les murs tournés à l'opposé de la lumière sont plus sombres. Les briques grossissent quand tu t'approches.
...
> **Réussi:** **Tu dois voir :** appuie sur **F5**. Le ciel glisse latéralement quand tu tournes, mais ne grossit pas quand tu marches. Les dalles du sol rétrécissent vers l'horizon et rejoignent proprement les murs.
...
> **Réussi:** **Tu dois voir :** les couleurs de secours quand une texture est vide, et une image plus grossière mais plus rapide avec un Floor Detail plus haut ou moins de Columns.
