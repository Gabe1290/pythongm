...
**Télécharger :** [PDF](downloads/Student-Handout-10-file-exchange-multiplayer_fr.pdf) · [ODT](downloads/Student-Handout-10-file-exchange-multiplayer_fr.odt)
...
> **Réussi:** **Tu dois voir :** appuie sur **F5**. Une grille blanche apparaît. Cliquer sur une case y met un X ; cliquer de nouveau ne fait rien.
...
> **Réussi:** **Tu dois voir :** lance le jeu sur les deux ordinateurs. Appuie sur H sur l'un et sur J sur l'autre. « Waiting for opponent... » disparaît et chaque écran indique « You are X » ou « You are O ».
...
> **Réussi:** **Tu dois voir :** seul le joueur dont c'est le tour peut placer une marque. Une marque apparaît sur **les deux** écrans un instant après le clic, et les tours alternent X, O, X.
...
> **Réussi:** **Tu dois voir :** aligne trois marques et les deux écrans affichent qui a gagné.
