...
Diese Seite listet alle **113** in PyGameMaker verfügbaren Aktionen auf, genau so, wie sie im Aktionsauswahldialog der IDE erscheinen (einschließlich des Audio-Plugins und der 3D-Ansicht-Erweiterung). Aktionen sind Befehle, die ausgeführt werden, wenn ein Ereignis ausgelöst wird.
