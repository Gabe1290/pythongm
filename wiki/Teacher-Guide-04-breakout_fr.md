...
**Télécharger :** [PDF](downloads/Teacher-Guide-04-breakout_fr.pdf) · [ODT](downloads/Teacher-Guide-04-breakout_fr.odt) · [Projets de référence (ZIP)](downloads/solutions/04_breakout_checkpoints.zip)
...
> **Astuce:** **Projets de référence.** Téléchargez les projets par étapes sur le wiki (`04_breakout_checkpoints.zip`) : un projet pour la fin de chaque phase. Donnez à un élève bloqué la phase précédente pour qu'il continue.
