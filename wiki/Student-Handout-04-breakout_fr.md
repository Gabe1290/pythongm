...
**Télécharger :** [PDF](downloads/Student-Handout-04-breakout_fr.pdf) · [ODT](downloads/Student-Handout-04-breakout_fr.odt)
...
> **Réussi:** **Tu dois voir :** appuie sur **F5**. La raquette bouge avec les flèches et s'arrête aux murs. La balle rebondit partout ; si elle passe sous la raquette, elle revient en haut.
...
> **Réussi:** **Tu dois voir :** appuie sur **F5**. La balle détruit les briques et rebondit. Chaque brique vaut 10 points (tu ne vois pas encore le score).
...
> **Réussi:** **Tu dois voir :** appuie sur **F5**. Les briques de toutes les couleurs se cassent quand la balle les touche.
...
> **Réussi:** **Tu dois voir :** le score et les vies s'affichent en haut. Chaque chute coûte une vie. Après la troisième chute, tu obtiens un message Game Over, le tableau des meilleurs scores, et le jeu se ferme.
