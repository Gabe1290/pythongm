...
Ця сторінка містить усі **161** дії, доступні в PyGameMaker, саме так, як вони відображаються в засобі вибору дій IDE (включно з плагіном Audio та розширенням 3D-вигляд). Дії — це команди, що виконуються, коли спрацьовує подія.
