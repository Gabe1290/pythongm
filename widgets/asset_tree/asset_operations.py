...
class AssetOperations:
    ...
    def perform_asset_rename(self, asset_data: Dict, new_name: str) -> bool:
        ...
        try:
            ...
            if save_project_data(project_file, project_data):
                print(f"💾 Project file updated with renamed asset (direct method)")
                return True
            else:
                return False
    ...
    def refresh_asset_item_after_rename(self, item, new_name: str):
            ...
            try:
                ...
                if asset_type in ["sprite", "background", "sprites", "backgrounds"]:
                    print(f"   ✓ Asset type matches sprite/background check")
                    ...
                    if new_file_path.exists():
                        try:
                            ...
                            if not pixmap.isNull():
                                ...
                                print(f"   ✅ Thumbnail icon set successfully")
                            else:
                                print(f"   ⚠️ Pixmap is null after loading")
                    ...
                    print(f"   ✗ Asset type did not match sprite/background check")
