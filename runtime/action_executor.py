...
class ActionExecutor(DrawingMixin, MovementMixin, ScoreLivesHealthMixin, RoomMixin, SpawnMixin, ParticleTimelineMixin, FlowMixin, AppearanceMixin, GameStateMixin, DialogSystemMixin):
