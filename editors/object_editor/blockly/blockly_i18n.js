...
const BLOCK_MESSAGES = {
    'fr': {
        ...
        'grid_move_prefix': 'Déplacer grille',
        'grid_move_size': 'taille',
        'grid_move_tooltip': "Déplace d'une case dans la direction spécifiée",
        ...
        'if_can_push_prefix': 'Si peut pousser',
        'if_can_push_direction': 'en direction',
        'if_can_push_then': 'alors',
        'if_can_push_else': 'sinon',
        'if_can_push_tooltip': 'Vérifie si une caisse peut être poussée (style Sokoban)',
        ...
        'room_goto_previous': 'Aller au niveau précédent',
        'room_goto_previous_tooltip': 'Va au niveau précédent',
        ...
        'room_if_next_exists': 'Si niveau suivant existe',
    ...
    'de': {
        ...
        'grid_move_prefix': 'Raster bewegen',
        'grid_move_size': 'Größe',
        'grid_move_tooltip': 'Bewegt ein Rasterfeld in die angegebene Richtung',
        ...
        'if_can_push_prefix': 'Wenn schiebbar',
        'if_can_push_direction': 'in Richtung',
        'if_can_push_then': 'dann',
        'if_can_push_else': 'sonst',
        'if_can_push_tooltip': 'Prüft ob eine Kiste geschoben werden kann (Sokoban-Stil)',

        // Room blocks
        'room_goto_next': 'Gehe zum nächsten Raum',
        'room_goto_next_tooltip': 'Geht zum nächsten Raum',
        'room_goto_previous': 'Gehe zum vorherigen Raum',
        'room_goto_previous_tooltip': 'Geht zum vorherigen Raum',
        ...
        'room_if_next_exists': 'Wenn nächster Raum existiert',
    ...
    'it': {
        ...
        'grid_move_prefix': 'Muovi griglia',
        'grid_move_size': 'dimensione',
        'grid_move_tooltip': 'Muove di una casella nella direzione specificata',
        ...
        'if_can_push_prefix': 'Se può spingere',
        'if_can_push_direction': 'in direzione',
        'if_can_push_then': 'allora',
        'if_can_push_else': 'altrimenti',
        'if_can_push_tooltip': 'Controlla se una cassa può essere spinta (stile Sokoban)',

        // Room blocks
        'room_goto_next': 'Vai alla stanza successiva',
        'room_goto_next_tooltip': 'Vai alla stanza successiva',
        'room_goto_previous': 'Vai alla stanza precedente',
        'room_goto_previous_tooltip': 'Vai alla stanza precedente',
        ...
        'room_if_next_exists': 'Se stanza successiva esiste',
...
const CATEGORY_MESSAGES = {
    ...
    'uk': {
        ...
        'event_step': 'Кожен крок',
        'event_step_tooltip': 'Виконується кожен кадр',
        'event_draw': 'Коли малювати',
        'event_draw_tooltip': 'Виконується під час фази малювання',
        'event_destroy': 'Коли знищено',
        'event_destroy_tooltip': 'Виконується коли об\'єкт знищено',
        'event_keyboard': 'Коли клавіша %1 натиснута',
        'event_keyboard_tooltip': 'Визначає коли клавіша натиснута',
        'event_keyboard_nokey': 'Клавіатура: Жодної клавіші',
        'event_keyboard_nokey_tooltip': 'Виконується коли жодна клавіша не натиснута',
        'event_keyboard_anykey': 'Клавіатура: Будь-яка клавіша',
        'event_keyboard_anykey_tooltip': 'Виконується коли будь-яка клавіша натиснута',
        'event_keyboard_held_prefix': 'Клавіатура:',
        'event_keyboard_held_suffix': '(утримується)',
        'event_keyboard_held_tooltip': 'Виконується безперервно поки клавіша утримується',
        'event_keyboard_press_prefix': 'Клавіша натиснута:',
        'event_keyboard_press_tooltip': 'Виконується один раз коли клавіша натиснута',
        'event_keyboard_release_prefix': 'Клавіша відпущена:',
        'event_keyboard_release_tooltip': 'Виконується один раз коли клавіша відпущена',
        'event_mouse_prefix': 'Коли миша',
        'event_mouse_tooltip': 'Виконується при подіях миші',
        'event_collision_prefix': 'Коли зіткнення з',
        'event_collision_tooltip': 'Виконується при зіткненні з іншим об\'єктом',
        'event_alarm_prefix': 'Коли будильник',
        'event_alarm_suffix': 'спрацьовує',
        'event_alarm_tooltip': 'Виконується коли будильник досягає нуля',

        // Movement blocks
        'move_set_hspeed_prefix': 'встановити горизонтальну швидкість на',
        'move_set_hspeed': 'встановити горизонтальну швидкість на %1',
        'move_set_hspeed_tooltip': 'Встановлює горизонтальну швидкість (X)',
        'move_set_vspeed_prefix': 'встановити вертикальну швидкість на',
        'move_set_vspeed': 'встановити вертикальну швидкість на %1',
        'move_set_vspeed_tooltip': 'Встановлює вертикальну швидкість (Y)',
        'move_stop': 'зупинити рух',
        'move_stop_tooltip': 'Зупиняє весь рух',
        'move_direction_prefix': 'Рухатись',
        'move_direction_suffix': 'зі швидкістю',
        'move_direction': 'рухатись в напрямку %1 швидкість %2',
        'move_direction_tooltip': 'Рухатись в напрямку (4 напрямки)',
        'move_towards_prefix': 'Рухатись до x:',
        'move_towards_y': 'y:',
        'move_towards_speed': 'зі швидкістю:',
        'move_towards': 'рухатись до x: %1 y: %2',
        'move_towards_tooltip': 'Рухатись до точки',
        'move_snap_to_grid_prefix': 'Вирівняти до сітки розмір',
        'move_snap_to_grid': 'вирівняти до сітки %1',
        'move_snap_to_grid_tooltip': 'Вирівнює позицію до сітки',
        'move_jump_to_prefix': 'Стрибнути до x:',
        'move_jump_to_y': 'y:',
        'move_jump_to': 'стрибнути до x: %1 y: %2',
        'move_jump_to_tooltip': 'Миттєва телепортація',
        'grid_move_prefix': 'Рухатись по сітці',
        'grid_move_size': 'розмір',
        'grid_move_tooltip': 'Рухає на одну клітинку у вказаному напрямку',
        'grid_stop_if_no_keys_prefix': 'Зупинитись якщо жодної клавіші (сітка',
        'grid_stop_if_no_keys_suffix': ')',
        'grid_stop_if_no_keys': 'якщо жодної клавіші зупинитись (сітка %1)',
        'grid_stop_if_no_keys_tooltip': 'Зупиняє рух по сітці якщо жодна клавіша не натиснута',
        'grid_check_keys_and_move_prefix': 'Перевірити клавіші і рухатись (сітка',
        'grid_check_keys_and_move_middle': ', швидкість',
        'grid_check_keys_and_move_suffix': ')',
        'grid_check_keys_and_move': 'перевірити клавіші і рухатись (сітка %1 швидкість %2)',
        'grid_check_keys_and_move_tooltip': 'Перевіряє клавіші і рухає по сітці',
        'grid_if_on_grid_prefix': 'Якщо на сітці (розмір',
        'grid_if_on_grid_suffix': ')',
        'grid_if_on_grid_do': 'виконати',
        'grid_if_on_grid': 'якщо на сітці %1',
        'grid_if_on_grid_tooltip': 'Виконує якщо вирівняно до сітки',
        'set_gravity_prefix': 'Встановити напрямок гравітації:',
        'set_gravity_strength': 'сила:',
        'set_gravity': 'встановити гравітацію на %1',
        'set_gravity_tooltip': 'Застосовує силу гравітації',
        'set_friction_prefix': 'Встановити тертя на',
        'set_friction': 'встановити тертя на %1',
        'set_friction_tooltip': 'Застосовує тертя',
        'reverse_horizontal': 'Обернути горизонтальний рух',
        ...
        'set_alarm_middle': 'на',
        'set_alarm_suffix': 'кроків',
        'set_alarm': 'встановити будильник %1 на %2',
        'set_alarm_tooltip': 'Встановлює будильник (0-11)',

        // Drawing blocks
        'draw_text_prefix': 'Малювати текст',
        'draw_text_x': 'в x:',
        'draw_text_y': 'y:',
        'draw_text': 'малювати текст %1 в x: %2 y: %3',
        'draw_text_tooltip': 'Показує текст',
        'draw_rectangle_prefix': 'Малювати прямокутник в x:',
        'draw_rectangle_y': 'y:',
        'draw_rectangle_width': 'ширина:',
        'draw_rectangle_height': 'висота:',
        'draw_rectangle_color': 'колір:',
        'draw_rectangle': 'малювати прямокутник x: %1 y: %2 ширина: %3 висота: %4 колір: %5',
        'draw_rectangle_tooltip': 'Малює заповнений прямокутник',
        'draw_circle_prefix': 'Малювати коло в x:',
        'draw_circle_y': 'y:',
        'draw_circle_radius': 'радіус:',
        'draw_circle_color': 'колір:',
        'draw_circle': 'малювати коло x: %1 y: %2 радіус: %3 колір: %4',
        'draw_circle_tooltip': 'Малює заповнене коло',
        'set_sprite_prefix': 'Встановити спрайт на',
        'set_sprite': 'встановити спрайт на %1',
        'set_sprite_tooltip': 'Змінює зображення спрайту',
        'set_alpha_prefix': 'Встановити прозорість на',
        'set_alpha_suffix': '(0-1)',
        'set_alpha': 'встановити прозорість на %1',
        'set_alpha_tooltip': 'Встановлює прозорість (0-1)',

        // Score/Lives/Health blocks
        'score_set_prefix': 'Встановити рахунок на',
        'score_set': 'встановити рахунок на %1',
        'score_set_tooltip': 'Встановлює значення рахунку',
        'score_add_prefix': 'Додати до рахунку',
        'score_add': 'додати %1 до рахунку',
        'score_add_tooltip': 'Змінює рахунок',
        'lives_set_prefix': 'Встановити життя на',
        'lives_set': 'встановити життя на %1',
        'lives_set_tooltip': 'Встановлює кількість життів',
        'lives_add_prefix': 'Додати до життів',
        'lives_add': 'додати %1 до життів',
        'lives_add_tooltip': 'Змінює життя',
        'health_set_prefix': 'Встановити здоров\'я на',
        'health_set': 'встановити здоров\'я на %1',
        'health_set_tooltip': 'Встановлює значення здоров\'я',
        'health_add_prefix': 'Додати до здоров\'я',
        'health_add': 'додати %1 до здоров\'я',
        'health_add_tooltip': 'Змінює здоров\'я',
        'draw_score_prefix': 'Показати рахунок в x:',
        'draw_score_y': 'y:',
        'draw_score': 'показати рахунок в x: %1 y: %2',
        'draw_score_tooltip': 'Показує текст рахунку',
        'draw_lives_prefix': 'Показати життя в x:',
        'draw_lives_y': 'y:',
        'draw_lives': 'показати життя в x: %1 y: %2 спрайт: %3',
        'draw_lives_tooltip': 'Показує іконки життів',
        ...
        // Instance blocks
        'instance_destroy': 'Знищити цей екземпляр',
        'instance_destroy_tooltip': 'Знищує цей об\'єкт',
        'instance_destroy_other': 'Знищити інший екземпляр',
        'instance_destroy_other_tooltip': 'Знищує об\'єкт при зіткненні',
        'instance_create_prefix': 'Створити',
        'instance_create_x': 'в x:',
        'instance_create_y': 'y:',
        'instance_create': 'створити екземпляр %1 в x: %2 y: %3',
        'instance_create_tooltip': 'Створює новий об\'єкт',
        'if_can_push_prefix': 'Якщо можна штовхнути',
        'if_can_push_direction': 'в напрямку',
        'if_can_push_then': 'тоді',
        'if_can_push_else': 'інакше',
        'if_can_push_tooltip': 'Перевіряє чи можна штовхнути ящик (стиль Сокобан)',

        // Room blocks
        'room_goto_next': 'Перейти до наступної кімнати',
        'room_goto_next_tooltip': 'Переходить до наступної кімнати',
        'room_goto_previous': 'Перейти до попередньої кімнати',
        'room_goto_previous_tooltip': 'Переходить до попередньої кімнати',
        'room_restart': 'Перезапустити кімнату',
        'room_restart_tooltip': 'Перезапускає поточну кімнату',
        'room_goto_prefix': 'Перейти до кімнати',
        'room_goto': 'перейти до кімнати %1',
        'room_goto_tooltip': 'Переходить до певної кімнати',
        'room_if_next_exists': 'Якщо наступна кімната існує',
        ...
        // Value blocks
        'value_x': 'позиція x',
        'value_x_tooltip': 'Координата X',
        'value_y': 'позиція y',
        'value_y_tooltip': 'Координата Y',
        'value_hspeed': 'горизонтальна швидкість',
        'value_hspeed_tooltip': 'Швидкість X',
        'value_vspeed': 'вертикальна швидкість',
        'value_vspeed_tooltip': 'Швидкість Y',
        'value_score': 'рахунок',
        'value_score_tooltip': 'Значення рахунку',
        'value_lives': 'життя',
        'value_lives_tooltip': 'Кількість життів',
        'value_health': 'здоров\'я',
        'value_health_tooltip': 'Значення здоров\'я',
        'value_mouse_x': 'миша x',
        'value_mouse_x_tooltip': 'Позиція X миші',
        'value_mouse_y': 'миша y',
        'value_mouse_y_tooltip': 'Позиція Y миші',

        // Sound blocks
        'sound_play_prefix': 'Грати звук',
        'sound_play': 'грати звук %1',
        'sound_play_tooltip': 'Грає звуковий ефект',
        'music_play_prefix': 'Грати музику',
        'music_play': 'грати музику %1',
        'music_play_tooltip': 'Грає фонову музику',
        'music_stop': 'Зупинити музику',
        'music_stop_tooltip': 'Зупиняє музику',

        // Output blocks
        'output_message_prefix': 'Показати повідомлення',
        'output_message': 'показати повідомлення %1',
        'output_message_tooltip': 'Показує діалогове вікно',
        ...
        // Math blocks
        'math_square_root': 'квадратний корінь',
        'math_absolute': 'абсолютне значення',
        'math_random_int': 'випадкове ціле від %1 до %2',
        'math_round': 'округлити',
        'math_floor': 'округлити вниз',
        'math_ceiling': 'округлити вгору',
        'math_sin': 'синус',
        'math_cos': 'косинус',
        'math_tan': 'тангенс',
