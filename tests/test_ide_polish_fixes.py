...
# maze_3 ("maze3_reimport") and (the now-removed) plateforme_4/5
# ("_refresh2") kept their working names through the rc.12 cleanup; caught
# 2026-07-11 when the HTML5 exports came out with the working names baked
# into the filename and window title. match3_1 is exempt: its display name
# is "Match3Game".
